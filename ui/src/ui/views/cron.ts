  ...
  return html`
    <section class="grid grid-cols-2">
      <div class="card">
        ...
        <div class="card-sub">网关所有的 Cron 调度器状态。</div>
      ...
      <div class="card">
        ...
        <div class="card-sub">创建一个定时唤醒或代理运行任务。</div>
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="card-sub">存储在网关中的所有计划任务。</div>
      ${props.jobs.length === 0
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="card-sub">最近运行记录：${props.runsJobId ?? "(请选择一个任务)"}。</div>
    ...
    <div class=${itemClass} @click=${() => props.onLoadRuns(job.id)}>
      <div class="list-main">
        ...
        <div class="chip-row" style="margin-top: 6px;">
          <span class="chip">${job.enabled ? "启用" : "禁用"}</span>
