    ...
    <div class="list-item">
      <div class="list-main">
        ...
        ${tokens.length === 0
          ...
          : html`
              <div class="muted" style="margin-top: 10px;">Token 列表</div>
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            当使用 <span class="mono">exec host=node</span> 时将代理绑定到特定节点。
          </div>
        </div>
        <button
          class="btn"
...
function renderExecApprovals(state: ExecApprovalsState) {
  ...
  return html`
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          <div class="card-title">执行批准</div>
          <div class="card-sub">
            <span class="mono">exec host=gateway/node</span> 的白名单和批准策略。
          </div>
        </div>
        <button
          class="btn"
      ...
      ${!ready
        ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            <div class="muted">加载执行批准以编辑白名单。</div>
  ...
  return html`
    <div class="list" style="margin-top: 12px;">
      ...
      ${state.target === "node" && !hasNodes
        ? html`<div class="muted">尚无节点通告执行批准。</div>`
        : nothing}
    </div>
  `;
}
