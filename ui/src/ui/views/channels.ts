  ...
  return html`
    ...
    <section class="card" style="margin-top: 18px;">
      <div class="row" style="justify-content: space-between;">
        ...
        <div class="muted">${props.lastSuccessAt ? formatAgo(props.lastSuccessAt) : "不适用"}</div>
      </div>
      ${props.lastError
        ...
        : html`
            <div class="status-list" style="margin-top: 16px;">
              <div>
                ...
                <span>${configured == null ? "不适用" : configured ? "是" : "否"}</span>
              </div>
              <div>
                <span class="label">运行中</span>
                <span>${running == null ? "不适用" : running ? "是" : "否"}</span>
              </div>
              <div>
                <span class="label">已连接</span>
                <span>${connected == null ? "不适用" : connected ? "是" : "否"}</span>
              </div>
            </div>
          `}
    ...
    <div class="account-card">
      ...
      <div class="status-list account-card-status">
        ...
        <div>
          ...
          <span>${account.lastInboundAt ? formatAgo(account.lastInboundAt) : "不适用"}</span>
        </div>
        ${account.lastError
          ? html`
