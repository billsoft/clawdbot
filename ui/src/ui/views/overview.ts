...
export function renderOverview(props: OverviewProps) {
  ...
  const authHint = (() => {
      ...
      return html`
        <div class="muted" style="margin-top: 8px;">
          ...
          <div style="margin-top: 6px;">
            <span class="mono">moltbot dashboard --no-open</span> → 生成带令牌的 URL<br />
            <span class="mono">moltbot doctor --generate-gateway-token</span> → 设置令牌
          </div>
          <div style="margin-top: 6px;">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        认证失败。请重新复制带令牌的 URL
        <span class="mono">moltbot dashboard --no-open</span>，或更新令牌，
        然后点击连接。
        <div style="margin-top: 6px;">
          <a
            class="session-link"
  ...
  const insecureContextHint = (() => {
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        此页面为 HTTP，浏览器阻止设备身份验证。请使用 HTTPS (Tailscale Serve) 或
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="note-grid" style="margin-top: 14px;">
        <div>
          ...
          <div class="muted">
            建议使用 serve 模式，通过 tailnet 认证保持网关在回环地址运行。
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="muted">为定期运行的任务使用独立会话。</div>
        </div>
      </div>
    </section>
  `;
