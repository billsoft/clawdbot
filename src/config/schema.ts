...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.tavily.searchDepth": 'Search depth ("basic" or "advanced").',
  "tools.web.search.tavily.includeRawContent": "Include raw content in Tavily results.",
  "tools.web.search.tavily.includeImages": "Include images in Tavily results.",
  "tools.web.search.tavily.includeAnswer": "Include answer in Tavily results.",
